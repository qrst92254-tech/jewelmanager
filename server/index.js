...
async function startServer() {
    try {
        ...
        app.use('/api/products', requireApiAuth, checkSubscription, productRoutes);
        app.use('/api/sales', requireApiAuth, checkSubscription, salesRoutes);
        app.use('/api/customers', requireApiAuth, checkSubscription, customersRoutes);
        app.use('/api/karigar', requireApiAuth, checkSubscription, karigarRoutes);
        app.use('/api/girvi', requireApiAuth, checkSubscription, girviRoutes);
        app.use('/api/schemes', requireApiAuth, checkSubscription, schemesRoutes);
        app.use('/api/repairs', requireApiAuth, checkSubscription, repairsRoutes);
        app.use('/api/quotations', requireApiAuth, checkSubscription, quotationsRoutes);
        app.use('/api/purchases', requireApiAuth, checkSubscription, purchasesRoutes);
        app.use('/api/reports', requireApiAuth, checkSubscription, reportsRoutes);
        app.use('/api/accounting', requireApiAuth, checkSubscription, accountingRoutes);
        app.use('/api/settings', requireApiAuth, checkSubscription, settingsRoutes);
        app.use('/api/import', requireApiAuth, checkSubscription, importRoutes);
